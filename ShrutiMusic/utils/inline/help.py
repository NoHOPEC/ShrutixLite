...
def help_pannel_page1(_, START: Union[bool, int] = None):
    return InlineKeyboardMarkup(
        [
            ...
            [
                InlineKeyboardButton(text="❖ Pᴀɢᴇ 𝟺", callback_data="help_page_4"),
                InlineKeyboardButton(text="Pᴀɢᴇ 𝟸 ❖", callback_data="help_page_2"),
            ],
            [
...
def help_pannel_page2(_, START: Union[bool, int] = None):
    return InlineKeyboardMarkup(
        [
            ...
            [
                InlineKeyboardButton(text="❖ Pᴀɢᴇ 𝟷", callback_data="help_page_1"),
                InlineKeyboardButton(text="Pᴀɢᴇ 𝟹 ❖", callback_data="help_page_3"),
            ],
            [
                InlineKeyboardButton(
                    text=_["BACK_BUTTON"] if START else _["CLOSE_BUTTON"],
    ...
    return InlineKeyboardMarkup(
        [
            ...
            [
                ...
                InlineKeyboardButton(text=_["H_B_53"], callback_data="help_callback hb53"),
                InlineKeyboardButton(text=_["H_B_50"], callback_data="help_callback hb50"),
            ],
            [
                InlineKeyboardButton(text=_["H_B_51"], callback_data="help_callback hb51"),
                InlineKeyboardButton(text=_["H_B_49"], callback_data="help_callback hb49"),
                InlineKeyboardButton(text=_["H_B_52"], callback_data="help_callback hb52"),
            ],
            [
                InlineKeyboardButton(text="❖ Pᴀɢᴇ 𝟹", callback_data="help_page_3"),
                InlineKeyboardButton(text="Pᴀɢᴇ 𝟷 ❖", callback_data="help_page_1"),
