...
async def helper_private(
    ...
    if is_callback:
        ...
        # Try message with effect, fallback to normal if fails
        try:
...
async def helper_cb(client, CallbackQuery, _):
    ...
    def get_keyboard_for(cb):
        page1 = ["hb1", "hb2", "hb3", "hb4", "hb5", "hb6", "hb7", "hb8", "hb9", "hb10", "hb11", "hb12", "hb13", "hb14"]
        
        # Page 2: H_B_15 to H_B_28 (hb15 to hb28) 
        page2 = ["hb15", "hb16", "hb17", "hb18", "hb19", "hb20", "hb21", "hb22", "hb23", "hb24", "hb25", "hb26", "hb27", "hb28"]
        
        # Page 3: H_B_29 to H_B_33 (hb29 to hb40)
        page3 = ["hb29", "hb30", "hb31", "hb32", "hb33", "hb34", "hb35", "hb36", "hb37", "hb38", "hb39", "hb40", "hb41", "hb42"]
        page4 = ["hb43", "hb44", "hb45", "hb46", "hb47", "hb48", "hb49", "hb50", "hb51", "hb52", "hb53"]
    ...
    if cb == "hb1":
        ...
        await CallbackQuery.edit_message_text(helpers.HELP_42, reply_markup=get_keyboard_for(cb))
    elif cb == "hb43":
        await CallbackQuery.edit_message_text(helpers.HELP_43, reply_markup=get_keyboard_for(cb))
    elif cb == "hb44":
        await CallbackQuery.edit_message_text(helpers.HELP_44, reply_markup=get_keyboard_for(cb))
    elif cb == "hb45":
        await CallbackQuery.edit_message_text(helpers.HELP_45, reply_markup=get_keyboard_for(cb))
    elif cb == "hb46":
        await CallbackQuery.edit_message_text(helpers.HELP_46, reply_markup=get_keyboard_for(cb))
    elif cb == "hb47":
        await CallbackQuery.edit_message_text(helpers.HELP_47, reply_markup=get_keyboard_for(cb))
    elif cb == "hb48":
        await CallbackQuery.edit_message_text(helpers.HELP_48, reply_markup=get_keyboard_for(cb))
    elif cb == "hb49":
        await CallbackQuery.edit_message_text(helpers.HELP_49, reply_markup=get_keyboard_for(cb))
    elif cb == "hb50":
        await CallbackQuery.edit_message_text(helpers.HELP_50, reply_markup=get_keyboard_for(cb))
    elif cb == "hb51":
        await CallbackQuery.edit_message_text(helpers.HELP_51, reply_markup=get_keyboard_for(cb))
    elif cb == "hb52":
        await CallbackQuery.edit_message_text(helpers.HELP_52, reply_markup=get_keyboard_for(cb))
    elif cb == "hb53":
        await CallbackQuery.edit_message_text(helpers.HELP_53, reply_markup=get_keyboard_for(cb))
